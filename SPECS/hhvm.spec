# hhvm
%global hhvm_commit 71ecbd8fb5e94b2a008387a2b5e9a8df5c6f5c7b
...
Source0:        https://github.com/facebook/%{name}/archive/%{hhvm_commit}/%{name}-%{hhvm_commit}.tar.gz
